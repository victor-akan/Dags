...
etl_args = {
    "dest_table_name" : "air_etl_visa_trxns",
    ...
    "source_query" : """
        ...
        and expl_code not in (111,44,98,100,157) and tra_amt>100
        and upper(remarks) like '% VISA %' and upper(remarks) not like '%VISA%CARD%'
        and led_code in (1,2,8,6,26,23,16,24,5011,5015,68,12,5012,4,59,13,82,67,65,5032,5021)
