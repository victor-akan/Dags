...
dag = DAG(
    dag_id='air_etl_nip_trxns_inflow',
    default_args=args,
    schedule_interval='@daily',
    tags=['NIP','trxns','inflow'],
)



etl_args = {
    "dest_table_name" : "air_etl_nip_trxns_inflow",
    ...
    "source_query" : """
        ...
        where expl_code=102 and cus_num>99999 and can_rea_code=0 and cur_code=1 and deb_cre_ind=2
        and doc_alp = 'NIPT'
    """,
