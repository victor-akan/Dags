...
dag = DAG(
    dag_id='air_etl_nip_trxns_cust_trans',
    default_args=args,
    schedule_interval=None,
    tags=['NIP','trxns','transfer'],
)

etl_args = {
    "dest_table_name" : "air_etl_nip_trxns_cust_trans",
    ...
    "source_query" : """
        ...
        where expl_code in (643,102) 
        and cus_num>99999 and can_rea_code=0 and cur_code=1 and deb_cre_ind=1
